    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                <input type="number" min=0 name="bandwidth[{{ $Name }}]" id="bandwidth_{{ $Id }}" class="form-control my-1" placeholder="" value="" aria-describedby="inputGroupPrepend">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" min=0 name="lbqty[{{ $Name }}]" id="lbqty_{{ $Id }}" class="form-control my-1" placeholder="Quantity" value="">
        </div>
        <div class="form-group col-md-3">
            <h6><small>Cross Connect and Port Termination</small></h6>
            <input type="number" min=0 name="ccptqty[{{ $Name }}]" id="ccptqty_{{ $Id }}" class="form-control" placeholder="Quantity" value="">
        </div>
        <div class="form-group col-md-3 vpn">
            ...
            <div class="row">
                <div class="form-switch form-group form-check col-md-6">
                    ...
                    <input class="form-check-input check ml-1" role="switch" type="checkbox" id="ssl_vpn_{{ $Id }}" name="sslvpn[{{ $Name }}]">
                    <input type="number" min=0 name="sslvpnqty[{{ $Name }}]" class="hide form-control" placeholder="Quantity" value="" id="sslvpnqty_{{ $Id }}">
                </div>
                <div class="form-switch form-group form-check col-md-6">
                    <label class="form-check-label h6" for="ipsec_vpn">IPSEC VPN : </label>
                    <input class="form-check-input check ml-1" role="switch" type="checkbox" id="ipsec_vpn_{{ $Id }}" name="ipsec[{{ $Name }}]">
                    <input type="number" min=0 name="ipsecqty[{{ $Name }}]" class="hide form-control" placeholder="Quantity" value="" id="ipsecvpnqty_{{ $Id }}">
                </div>
            </div>
        </div>
        <div class="form-group col-md-3 replink">
            ...
            <div class="input-group">
                <input type="number" min=0 name="rep_link_qty[{{ $Name }}]" id="rep_link_qty_{{ $Id }}" class="form-control my-1" placeholder="" value="" aria-describedby="inputGroupPrepend">
