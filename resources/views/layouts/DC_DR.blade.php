        ...
        <div class="tab card card-body">
            <div class="form-row">
                <div class="form-group col-md-9">
                    <input type="text" class="form-control EstmtName" id="estmtname_{{ $Id }}" placeholder="Your Estimate" name="estmtname[{{ $Name }}]" required value="">
                </div>
                <div class="col-md-3 input-group ">
                    <input type="number" min=0 class="form-control small col-8 text-sm-left" id="period_{{ $Id }}" placeholder="Contract Period" min=1 name="period[{{ $Name }}]" required value="" aria-describedby="PeriodUnit_{{ $Id }}" style="font-size:15">
